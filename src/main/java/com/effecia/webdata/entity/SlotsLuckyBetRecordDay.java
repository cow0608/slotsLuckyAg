 ...
 */
@Entity
@Table(name="slots_lucky_bet_record_day")
@NamedQuery(name="SlotsLuckyBetRecordDay.findAll", query="SELECT s FROM SlotsLuckyBetRecordDay s")
public class SlotsLuckyBetRecordDay implements Serializable {
